                          ...
                          user.map((res)=>
                              ...
                              <tr>
                                      ...
                                      <td>
                                       ...
                                       <Link className="btn -primary "    style={{color: "black"}}   onClick={() =>setEditModel(true)}><BiCommentEdit /></Link> {'\u00A0'}
                                  
                                        <Link className="btn -dengar "    style={{color: "black"}}  to={"delteUser/"+res.id }  >
                                        <BiTrash /></Link>
