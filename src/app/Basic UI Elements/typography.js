            ...
            <div className="row">
              ...
              <div className="col-md-6 grid-margin stretch-card">
                <div className="card">
                  <div className="card-body">
                    ...
                    <p className="card-description"> Wrap content inside<code
                        >&lt;blockquote className="blockquote"&gt;</code>
                    </p>
              ...
              <div className="col-md-6 grid-margin stretch-card">
                <div className="card">
                  <div className="card-body">
                    ...
                    <div className="row">
                      <div className="col-md-6">
                        <address>
                          <p className="font-weight-bold">Breeze imc</p>
                          <p>695 lsom Ave,</p>
                          <p>Suite 00</p>
                  ...
                  <div className="card-body">
                    ...
                    <p className="card-description">Use className <code>.lead</code></p>
              ...
              <div className="col-md-4 grid-margin stretch-card">
                <div className="card">
                  <div className="card-body">
                    ...
                    <p className="card-description"> Add className <code>.list-ticked</code> to <code>&lt;ul&gt;</code>
                    </p>
              ...
              <div className="col-md-4 grid-margin stretch-card">
                <div className="card">
                  <div className="card-body">
                    <h4 className="card-title">List with icon</h4>
                    <p className="card-description"> Add className <code>.list-arrow</code> to <code>&lt;ul&gt;</code>
                    </p>
              ...
              <div className="col-md-4 grid-margin stretch-card">
                <div className="card">
                  <div className="card-body">
                    <h4 className="card-title">List with icon</h4>
                    <p className="card-description"> Add className <code>.list-star</code> to <code>&lt;ul&gt;</code>
                    </p>
