              ...
              <div class="col-12 grid-margin stretch-card">
                <div class="card">
                  ...
                  <div class="card-body">
                    ...
                    <p class="card-description"> Add class <code>.btn-outline</code> for outline buttons </p>
                    <div class="template-demo">
                  ...
                  <div class="card-body">
                    ...
                    <p class="card-description"> Add class <code>.btn-</code> for buttons in theme colors </p>
                    <div class="template-demo">
                  ...
                  <div class="card-body">
                    ...
                    <p class="card-description"> Add class <code>.btn-inverse- for inverse buttons</code>
                    </p>
                    <div class="template-demo">
                  ...
                  <div class="card-body">
                    <div class="row">
                      ...
                      <div class="col-md-5">
                        ...
                        <p class="card-description"> Use class <code>.btn-</code>
                        </p>
                        <div class="template-demo">
