              ...
              <div class="col-lg-12 grid-margin">
                <div class="card">
                  <div class="card-body">
                    ...
                    <p class="card-description"> Add class <code>.btn-gradient-bule</code> to the button inside <code>.dropdown</code>
                    </p>
                  ...
                  <div class="card-body">
                    ...
                    <p class="card-description"> Add class <code>.btn-outline-bule</code> to the button inside <code>.dropdown</code>
                    </p>
                    <div class="template-demo">
                      <div class="dropdown">
              ...
              <div class="col-lg-6 grid-margin stretch-card">
                <div class="card">
                  <div class="card-body">
                    ...
                    <p class="card-description"> Add class <code>.btn-10</code> to dropdown buttons </p>
